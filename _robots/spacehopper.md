...
Check-out the full robot [here](https://www.research-collection.ethz.ch/server/api/core/bitstreams/406317bd-cde7-4fd0-829a-cc5aff5cb213/content) and the [project page](https://www.spacehopper.ethz.ch/).