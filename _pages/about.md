...
My work focuses on legged robots, high-performance locomotion, and robust pipelines that bridge the gap between simulation and real-world deployment — with a strong emphasis on learning-based control, system identification, and real-world experimentation.
...
### 🐾 [Robots](/robots/)
A collection of robots I have worked with or helped bring to life — from quadrupeds to experimental platforms.
...
### 🛠️ [Projects](/projects/)
A curated selection of applied and exploratory projects — ranging from full-scale research systems to side experiments.

Some projects are polished, others show the raw process of experimentation — both are intentional.
...
If you’re interested in collaboration, research, or just curious about legged robots — feel free to explore.
